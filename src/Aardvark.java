...
public class Aardvark extends AardvarkSecond {
    ...
    AardvarkSecond aardvarkSecond = new AardvarkSecond();
    ...
    public void play() {
        ...
        switch (c2) {
            case 1:
                aardvarkSecond.generateDominoes(this);
                aardvarkSecond.shuffleDominoesOrder(this);
                aardvarkSecond.placeDominoes(this);
                aardvarkSecond.collateGrid(this);
                break;
            case 2:
                aardvarkSecond.generateDominoes(this);
                aardvarkSecond.shuffleDominoesOrder(this);
                aardvarkSecond.placeDominoes(this);
                aardvarkSecond.rotateDominoes(this);
                aardvarkSecond.collateGrid(this);
                break;
            default:
                aardvarkSecond.generateDominoes(this);
                ...
                aardvarkSecond.rotateDominoes(this);
                aardvarkSecond.rotateDominoes(this);
                aardvarkSecond.invertSomeDominoes(this);
                aardvarkSecond.collateGrid(this);
                break;
        }
        aardvarkSecond.printGridorGuess(grid);
        aardvarkSecond.generateGuesses(this);
        aardvarkSecond.collateGuessGrid(this);
        mode = 1;
        cf = 0;
        score = 0;
        startTime = System.currentTimeMillis();
        pictureFrame.PictureFrame(this);
        pictureFrame.dominoPanel.repaint();
        int c3 = -7;
        while (c3 != ZERO) {
            System.out.println();
            String h5 = "Play menu";
            ...
            switch (c3) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    aardvarkSecond.printGridorGuess(gg);
                    break;
                case 3:
                    Collections.sort(_g);
                    aardvarkSecond.printGuesses(this);
                    break;
                case 4:
                ...
                case 5:
                    ...
                    x13--;
                    y13--;
                    Domino lkj = aardvarkSecond.findAt(this, x13, y13, _g);
                    if (lkj == null) {
                ...
                case 6:
                    ...
                    switch (yy) {
                        ...
                        case 1:
                            ...
                            Domino dd = aardvarkSecond.findByLH(this, x5, x4, _d);
                        ...
                        case 2:
                            ...
                            x3--;
                            y3--;
                            Domino lkj2 = aardvarkSecond.findAt(this, x3, y3, _d);
                        ...
                        case 3: {
                            ...
                            for (int r = 0; r < 6; r++) {
                                for (int c = 0; c < 7; c++) {
                                    Domino hd = aardvarkSecond.findByLH(this, grid[r][c], grid[r][c + 1], _g);
                                    Domino vd = aardvarkSecond.findByLH(this, grid[r][c], grid[r + 1][c], _g);
        ...
        aardvarkSecond.recordTheScore(this);
        System.out.println("Here is the solution:");
        System.out.println();
        Collections.sort(_d);
        aardvarkSecond.printDominoes(this);
