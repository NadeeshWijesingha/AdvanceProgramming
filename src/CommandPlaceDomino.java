public class CommandPlaceDomino implements Command {
    private final Aardvark aardvark;
    private int x13, y13;
    ...
    public void play() {
        ...
        if (x2 > 7 || y2 > 6) {
            ...
            Domino d = aardvark.aardvarkSecond.findByLH(aardvark, aardvark.grid[y][x], aardvark.grid[y2][x2], aardvark._g);
            if (d == null) {
            ...
            aardvark.score += 1000;
            aardvark.aardvarkSecond.collateGuessGrid(aardvark);
            aardvark.pictureFrame.dominoPanel.repaint();
        }
    }
    ...
    public void undo() {
        x13--;
        y13--;
        Domino placedDomino = aardvark.aardvarkSecond.findAt(aardvark, x13, y13, aardvark._g);
